...
cljs.core.find = function(a, b) {
  return null != a && cljs.core.associative_QMARK_(a) && cljs.core.contains_QMARK_(a, b) ? cljs.core.ifind_QMARK_(a) ? cljs.core._find(a, b) : new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [b, cljs.core.get.cljs$core$IFn$_invoke$arity$2(a, b)], null) : null;
};
...
cljs.core.nil_iter = function() {
  "undefined" === typeof cljs.core.t_cljs$core10019 && (cljs.core.t_cljs$core10019 = function(a) {
    this.meta10020 = a;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
    this.cljs$lang$protocol_mask$partition1$ = 0;
  }, cljs.core.t_cljs$core10019.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
    return new cljs.core.t_cljs$core10019(b);
  }, cljs.core.t_cljs$core10019.prototype.cljs$core$IMeta$_meta$arity$1 = function(a) {
    return this.meta10020;
  }, cljs.core.t_cljs$core10019.prototype.hasNext = function() {
    return !1;
  }, cljs.core.t_cljs$core10019.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t_cljs$core10019.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t_cljs$core10019.getBasis = function() {
    return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null, "meta10020", "meta10020", 1218686435, null)], null);
  }, cljs.core.t_cljs$core10019.cljs$lang$type = !0, cljs.core.t_cljs$core10019.cljs$lang$ctorStr = "cljs.core/t_cljs$core10019", cljs.core.t_cljs$core10019.cljs$lang$ctorPrWriter = function(a, b, c) {
    return cljs.core._write(b, "cljs.core/t_cljs$core10019");
  }, cljs.core.__GT_t_cljs$core10019 = function(a) {
    return new cljs.core.t_cljs$core10019(a);
  });
  return new cljs.core.t_cljs$core10019(cljs.core.PersistentArrayMap.EMPTY);
};
...
cljs.core.PersistentVector.prototype.cljs$core$IFind$_find$arity$2 = function(a, b) {
  return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [b, cljs.core.get.cljs$core$IFn$_invoke$arity$2(this, b)], null);
};
...
cljs.core.PersistentArrayMap.prototype.cljs$core$IFind$_find$arity$2 = function(a, b) {
  ...
  return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [this.arr[c], cljs.core.get.cljs$core$IFn$_invoke$arity$2(this, b)], null);
};
...
cljs.core.PersistentHashMap.prototype.cljs$core$IFind$_find$arity$2 = function(a, b) {
  return this.has_nil_QMARK_ ? new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null, this.nil_val], null) : this.root.inode_find(0, cljs.core.hash(b), b, null);
};
...
cljs.core.BlackNode.prototype.cljs$core$IFind$_find$arity$2 = function(a, b) {
  return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [this.key, this.val], null);
};
...
clojure.string.replace = function(a, b, c) {
  ...
  throw [cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid match arg: "), cljs.core.str.cljs$core$IFn$_invoke$arity$1(b)].join("");
};
...
clojure.string.capitalize = function(a) {
  return 2 > cljs.core.count.call(null, a) ? clojure.string.upper_case.call(null, a) : [cljs.core.str.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case.call(null, cljs.core.subs.call(null, a, 0, 1))), cljs.core.str.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case.call(null, cljs.core.subs.call(null, a, 1)))].join("");
};
...
var phoenix = {core:{}};
phoenix.core.notify = function(a) {
  return Phoenix.notify(a);
};
...
phoenix.core.alert = function(a) {
  ...
  b = 0 < b.length ? new cljs.core.IndexedSeq(b.slice(0), 0, null) : null;
  return phoenix.core.alert.cljs$core$IFn$_invoke$arity$variadic(b);
};
phoenix.core.alert.cljs$core$IFn$_invoke$arity$variadic = function(a) {
  var b = new Modal, c = Screen.main().flippedVisibleFrame();
  b.origin = {x:c.width / 2, y:c.height / 2};
  b.message = clojure.string.join.call(null, " ", a);
  b.duration = 2;
  return b.show();
};
...
phoenix.core.half_screen_width = function(a, b) {
  return (b.width - b.x) / 2;
};
phoenix.core.move_to_left_half = function() {
  var a = Window.focused();
  if (cljs.core.truth_(a)) {
    var b = a.screen().flippedVisibleFrame();
    return a.setFrame({x:b.x, y:b.y, width:phoenix.core.half_screen_width.call(null, a, b), height:b.height});
  }
  return null;
};
phoenix.core.move_to_right_half = function() {
  var a = Window.focused();
  if (cljs.core.truth_(a)) {
    var b = a.screen().flippedVisibleFrame();
    return a.setFrame({x:b.x + phoenix.core.half_screen_width.call(null, a, b), y:b.y, width:phoenix.core.half_screen_width.call(null, a, b), height:b.height});
  }
  return null;
};
phoenix.core.move_to_top_half = function() {
  var a = Window.focused();
  if (cljs.core.truth_(a)) {
    var b = a.screen().flippedVisibleFrame();
    return a.setFrame({x:b.x, y:b.y, width:b.width, height:b.height / 2});
  }
  return null;
};
phoenix.core.move_to_bottom_half = function() {
  var a = Window.focused();
  if (cljs.core.truth_(a)) {
    var b = a.screen().flippedVisibleFrame();
    return a.setFrame({x:b.x, y:b.y + b.height - b.height / 2, width:b.width, height:b.height / 2});
  }
  return null;
};
